...
/*
 * SWGFlightSearchPrice.h
 * 
 * 
 */

#ifndef SWGFlightSearchPrice_H_
#define SWGFlightSearchPrice_H_
...
class SWGFlightSearchPrice: public SWGObject {
public:
    SWGFlightSearchPrice();
    SWGFlightSearchPrice(QString* json);
    virtual ~SWGFlightSearchPrice();
    void init();
    void cleanup();
    ...
    SWGFlightSearchPrice* fromJson(QString &jsonString);
